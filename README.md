...
### Illustration of the Multi-Agent Decision Process in Ontology-Enhanced DTI Prediction

In this section, we provide a comprehensive illustration of the multi-agent reasoning process supporting our ontology-enhanced DTI prediction system.

Tables below present detailed outputs generated by the four specialized agents for selected drug-target pairs. Specifically, these tables capture the full decision trace:

- **Agent 1:** contextual subgraph-based reasoning extracted from the ontology-aligned KG  
- **Agent 2:** formal annotations from BioGenOnt using SPARQL queries  
- **Agent 3:** LLM-driven reasoning synthesis  
- **Agent 4:** final binary interaction decision  

For instance, the interaction between Citrulline and Nitric oxide synthase, inducible is explored in the second case, where multi-agent outputs collectively provide converging and biologically grounded justifications supporting an interaction. Conversely, the first case illustrates a non-interaction example (Baricitinib and Arabinose operon regulatory protein), reinforcing interpretability and transparency of negative predictions.

---

# 🔴 Negative Interaction Case

| Drug | Target Protein | Prediction | Ground Truth | Agent 1: Subgraph contextual information | Agent 2: Annotations from BioGenOnt | Agent 3: Interaction Determination via LLM-Driven Reasoning | Agent 4: Final Answer |
|------|---------------|------------|--------------|------------------------------------------|--------------------------------------|----------------------------------------------------------------|------------------------|
| Baricitinib | Arabinose operon regulatory protein | No | No interaction | In this study, we investigate the role of the transcription factor NF-κB in the regulation of gene expression in response to oxidative stress.  
Introduction: NF-κB is a transcription factor that plays a crucial role in the regulation of gene expression in response to oxidative stress. Oxidative stress is a state of cellular injury caused by the excessive production of reactive oxygen species (ROS), which can damage cellular macromolecules and lead to cell death. NF-κB is activated in response to oxidative stress and regulates the expression of genes involved in the response to oxidative stress, such as antioxidant enzymes and detoxification pathways.  
Methods: We used a mouse model of oxidative stress to investigate the role of NF-κB in the regulation of gene expression. Mice were exposed to the oxidative stress inducer, H2O2, and the expression of NF-κB and its target genes was analyzed.  
Results: Our results show that NF-κB is activated in response to oxidative stress and regulates the expression of genes involved in the response to oxidative stress. We found that NF-κB binds to specific DNA sequences in the promoter regions of its target genes and recruits coactivators to activate transcription. We also found that NF-κB regulates the expression of antioxidant enzymes, such as glutathione peroxidase and superoxide dismutase, which play a crucial role in protecting cells against oxidative damage.  
Discussion: Our findings provide evidence for the role of NF-κB in the regulation of gene expression in response to oxidative stress. The activation of NF-κB and the regulation of its target genes are crucial for the cell's response to oxidative stress and the maintenance of cellular homeostasis. The dysregulation of NF-κB has been implicated in a number of diseases, including cancer and neurodegenerative disorders, and our findings provide new insights into the molecular mechanisms underlying these diseases.  
Conclusion: NF-κB regulates gene expression in response to oxidative stress. | subonto-drug: [('label', 'baricitinib'), ('description', 'A pyrrolopyrimidine that is 7H-pyrrolo[2,3-d]pyrimidine substituted by a 1-[3-(cyanomethyl)-1-(ethanesulfonyl)azetidin-3-yl]-1H-pyrazol-4-yl group at position 5. It is an FDA approved selective Janus Kinase 1 and 2 (JAK1 and JAK2) inhibitor used for the treatment of rheumatoid arthritis.'), ('synonyms', [...])] | subonto-protein: [('label', 'arabinose operon regulatory protein'), ('description', 'A protein that is a translation product of the Escherichia coli K-12 araC gene or a 1:1 ortholog thereof.'), ('synonyms', ['araC'])] | Baricitinib is a JAK1/2 inhibitor; arabinose operon regulatory protein is araC transcription factor. NF-κB context shows oxidative stress response but no link between drug and protein. No mechanistic interaction exists. | No |

---

# 🟢 Positive Interaction Case

| Drug | Target Protein | Prediction | Ground Truth | Agent 1: Subgraph contextual information | Agent 2: Annotations from BioGenOnt | Agent 3: Interaction Determination via LLM-Driven Reasoning | Agent 4: Final Answer |
|------|---------------|------------|--------------|------------------------------------------|--------------------------------------|----------------------------------------------------------------|------------------------|
| Citrulline | Nitric oxide synthase, inducible | Yes | Interaction | Citrulline and nitric oxide synthase are two enzymes involved in amino acid biosynthesis. Citrulline is produced via citrulline synthase converting ornithine and CO₂. Nitric oxide synthase (NOS) converts L-arginine to citrulline and further metabolites. Citrulline is a substrate for NOS producing NO involved in blood flow, immune function, neurotransmission. NOS is inhibited by citrulline. Citrulline modulates NOS activity and inflammation pathways. NOS affects citrulline synthase activity. | subonto-drug: [('label','citrulline'),('description','The parent compound...'),('synonyms',[...])] | subonto-protein: [('label','nitric oxide synthase, inducible'),('description','Protein product of NOS2 gene...'),('synonyms',[...])] | Strong bidirectional metabolic and inflammatory interaction supported: citrulline is both substrate and regulator of NOS; NOS regulates citrulline metabolism; shared role in inflammation and NO production. | Yes |
