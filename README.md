...
In this appendix, we provide a comprehensive illustration of the multi-agent reasoning process supporting our ontology-enhanced DTI prediction system. Tables below present detailed outputs generated by the four specialized agents for selected drug-target pairs. Specifically, these tables capture the full decision trace, starting from Agent 1, which provides contextual subgraph-based reasoning extracted from the ontology-aligned KG, to Agent 2, which retrieves formal annotations from BioGenOnt using SPARQL queries. Agent 3 synthesizes the insights via LLM-driven reasoning, and Agent 4 formulates the final binary interaction decision.  

For instance, the interaction between Citrulline and Nitric oxide synthase, inducible is shown in the second table, where multi-agent outputs collectively provide converging and biologically grounded justifications supporting an interaction. Conversely, the first table illustrates a non-interaction case (e.g., Baricitinib and Arabinose operon regulatory protein), reinforcing interpretability and transparency of negative predictions.
...
|------|---------------|------------|--------------|------------------------------------------|--------------------------------------|----------------------------------------------------------------|------------------------|
| Baricitinib | Arabinose operon regulatory protein | No | No interaction | In this study, we investigate the role of the transcription factor NF-κB in the regulation of gene expression in response to oxidative stress. Introduction: NF-κB is a transcription factor that plays a crucial role in the regulation of gene expression in response to oxidative stress. Oxidative stress is a state of cellular injury caused by the excessive production of reactive oxygen species (ROS), which can damage cellular macromolecules and lead to cell death. NF-κB is activated in response to oxidative stress and regulates the expression of genes involved in the response to oxidative stress, such as antioxidant enzymes and detoxification pathways. Methods: We used a mouse model of oxidative stress to investigate the role of NF-κB in the regulation of gene expression. Mice were exposed to H2O2 and NF-κB expression was analyzed. Results: NF-κB regulates genes involved in oxidative stress response. Conclusion: NF-κB regulates gene expression under oxidative stress. | subonto-drug: [('label','baricitinib'), ('description','A JAK1/JAK2 inhibitor used for rheumatoid arthritis'), ('synonyms',[...])] / subonto-protein: [('label','arabinose operon regulatory protein'), ('description','Protein encoded by araC gene'), ('synonyms',['araC'])] | Baricitinib is a JAK1/2 inhibitor; arabinose operon regulatory protein is a bacterial transcription factor. No biological interaction exists between them. NF-κB context is unrelated. | No |
...
| Drug | Target Protein | Prediction | Ground Truth | Agent 1: Subgraph contextual information | Agent 2: Annotations from BioGenOnt | Agent 3: Interaction Determination via LLM-Driven Reasoning | Agent 4: Final Answer |
|------|---------------|------------|--------------|------------------------------------------|--------------------------------------|----------------------------------------------------------------|------------------------|
| Citrulline | Nitric oxide synthase, inducible | Yes | Interaction | Citrulline and nitric oxide synthase are enzymes involved in amino acid biosynthesis. Citrulline is produced from ornithine, and nitric oxide synthase converts L-arginine to citrulline and nitric oxide. Multiple regulatory pathways exist between them including modulation of enzyme activity and metabolic feedback loops. | subonto-drug: [('label','citrulline'), ('description','A non-proteinogenic amino acid'), ('synonyms',[...])] / subonto-protein: [('label','nitric oxide synthase, inducible'), ('description','NOS2 gene product'), ('synonyms',['iNOS','NOS2'])] | Citrulline and iNOS interact through metabolic pathways involving nitric oxide production, enzyme modulation, and inflammatory regulation. Evidence supports a bidirectional relationship. | Yes |
